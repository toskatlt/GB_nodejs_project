			...
			<div class="product-body">
				...
				<div class="product">
					...
					<a class="product-link" href="single_page.php">
						<img class="item-img" src="img/product/img_17.jpg" alt="Mango  People  T-shirt">
					...
					<div class="item">
					<a class="product-link" href="single_page.php">
						<img class="item-img" src="img/product/img_16.jpg" alt="Mango  People  T-shirt">
						<div class="item-text-block">
							<p class="item-name">Mango  People  T-shirt</p>
							<div class="item-footer">
								<p class="item-price pink">$52.00</p>
					...
					<div class="item">
						<a class="product-link" href="single_page.php">
							<img class="item-img" src="img/product/img_15.jpg" alt="Mango  People  T-shirt">
							<div class="item-text-block">
								<p class="item-name">Mango  People  T-shirt</p>
								<div class="item-footer">
									<p class="item-price pink">$52.00</p>
					...
					<div class="item">
						<a class="product-link" href="single_page.php">
							<img class="item-img" src="img/product/img_14.jpg" alt="Mango  People  T-shirt">
							<div class="item-text-block">
								<p class="item-name">Mango  People  T-shirt</p>
								<div class="item-footer">
									<p class="item-price pink">$52.00</p>
					...
					<div class="item">
						<a class="product-link" href="single_page.php">
							<img class="item-img" src="img/product/img_18.jpg" alt="Mango  People  T-shirt">
							<div class="item-text-block">
								<p class="item-name">Mango  People  T-shirt</p>
								<div class="item-footer">
									<p class="item-price pink">$52.00</p>
					...
					<div class="item">
						<a class="product-link" href="single_page.php">
							<img class="item-img" src="img/product/img_13.jpg" alt="Mango  People  T-shirt">
							<div class="item-text-block">
								<p class="item-name">Mango  People  T-shirt</p>
								<div class="item-footer">
									<p class="item-price pink">$52.00</p>
